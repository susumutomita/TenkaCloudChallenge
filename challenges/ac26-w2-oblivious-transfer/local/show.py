...
def main() -> None:
    ...
    print("  a belongs to the sender role; this editor implements both roles.")
    print("  These tiny parameters allow exhaustive exponent search; this is a teaching model.")
    print()
    ...
    print()
    print("  Count each B over q equally likely consecutive blind values, for each choice.")
    print("  Compare occurrence counts, not only the set of possible values.")
    print()
    print("== your AND gate ==")
    print(f"  party 0 holds x0 = {gate['x0']}, y0 = {gate['y0']}")
    print(f"  party 1 holds x1 = {gate['x1']}, y1 = {gate['y1']}")
    print(f"  so x = {gate['x0'] ^ gate['x1']} and y = {gate['y0'] ^ gate['y1']}, reconstructed here for learning")
    print()
