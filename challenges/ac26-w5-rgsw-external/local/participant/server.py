...
_WORKBENCH = PortalEditorSupport(
    ...
    description='数を桁に分けて足し戻す部品から、暗号化したビットを掛ける模型を作ります。rgsw.pyのdecomposeとrecomposeを実装し、公開テストのdecompose-round-tripsを確認します。',
    description_en='Build an encrypted-bit multiplication model from digit decomposition and reconstruction. Implement decompose and recompose in rgsw.py and inspect decompose-round-trips in public tests.',
