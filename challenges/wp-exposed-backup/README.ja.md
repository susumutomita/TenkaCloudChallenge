...
> TenkaCloud Challenge · `challenges/wp-exposed-backup` · 難易度 1 (入門) · 30〜45 分 · `multi-verify` 採点 (4 チェックポイント・100点・ヒント減点なし)
...
TenkaCloud 本体のオンボーディングが最初の実問題として案内する**導入問題**です (Issue #387)。
各チェックポイントに「観察 → 仮説→確認 → 答えと対策」の 3 段階ヒントがあり、**どのヒントを
開いても減点はありません** — ヒントを開くことは、この問題では学習の一部です。
