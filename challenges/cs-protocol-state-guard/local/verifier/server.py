...
def _check_guard(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["guard"], submission) and bool(SEED)


def _check_terminal(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["terminal"], submission) and bool(SEED)
