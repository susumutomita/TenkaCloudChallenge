...
def _check_replay(submission: object) -> tuple[bool, str]:
    correct, detail = _check_code(CODE_CHECKPOINT_PHASES["replay"], submission)
    return correct and bool(SEED), detail


def _check_bind(submission: object) -> tuple[bool, str]:
    correct, detail = _check_code(CODE_CHECKPOINT_PHASES["bind"], submission)
    return correct and bool(SEED), detail
