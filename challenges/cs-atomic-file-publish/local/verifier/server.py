...
def _check_publish(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["publish"], submission) and bool(SEED)


def _check_durable(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["durable"], submission) and bool(SEED)
