...
class LearnerSession:
    ...
    def module(self):
        return SimpleNamespace(**{name: (lambda *args, _name=name: self.call('schedule', _name, args))
                                  for name in ('rotr', 'small_sigma0', 'small_sigma1', 'big_sigma0', 'big_sigma1', 'choose', 'majority', 'expand_schedule')})
