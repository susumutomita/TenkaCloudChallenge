...
ROW_ARGS = {
    ...
    'predicate':('m','cases'), 'tamper':('m','cases','reports'), 'binding':('program','receipts'),
}
EXAMPLE = {
    ...
    'reports':[True,False,True,True], 'program':3,
    'receipts':[
        {'verified':True,'program':3,'claim':'exploit'},
        {'verified':True,'program':4,'claim':'exploit'},
        {'verified':True,'program':3,'claim':'accept'},
        {'verified':False,'program':3,'claim':'exploit'},
    ],
}
EXAMPLE_EXPECTED = {
