...
from fixtures.generate import GRADED, LINES, assignments, normalize_answer, setting, submission_binding, valid_spoof, valid_pair
...
def _check_line(line: str, submission: object) -> bool:
    ...
    if got is None:
        return False
    if line in ("lie-caught","miss-points"):
        return (valid_spoof if line=="lie-caught" else valid_pair)(setting(SEED)["public"], got)
