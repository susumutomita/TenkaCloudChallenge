# Deliver a handover note — S3 basics

[日本語](README.ja.md) · [Scope #887](https://github.com/susumutomita/TenkaCloudChallenge/issues/887)

Teammates at another site need the handover note. Put the supplied file in S3 so they can read it from the same storage.
