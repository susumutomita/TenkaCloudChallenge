...
def _check_rollup(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["rollup"], submission) and bool(SEED)


def _check_transition(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["transition"], submission) and bool(SEED)
