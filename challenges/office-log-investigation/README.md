# Trace the parcel destination — CloudWatch Logs basics
...
Run the provided receiver → find the matching receipt in CloudWatch Logs → report its destination → explain record correlation.
...
Two 128 MB Lambda functions, two one-day log groups, scoped roles and a capability-protected function URL.
...
The destination must match the actual log record for the submitted receipt and this team. Another execution or another team cannot pass.
