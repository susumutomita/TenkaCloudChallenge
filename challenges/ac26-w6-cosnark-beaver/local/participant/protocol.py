...
import secrets
from participant.mpc import Share, Triple, ParticipantRuntime
...
class Codec:
    ...
    def encode(self, value, depth=0):
        ...
        if not isinstance(value, (Share, Triple, ParticipantRuntime)):
        ...
        methods = ['value_of', 'add', 'sub', 'mul_public', 'add_public', 'zero',
