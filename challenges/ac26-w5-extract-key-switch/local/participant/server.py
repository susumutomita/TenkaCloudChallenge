...
_WORKBENCH = PortalEditorSupport(
    ...
    description='暗号文から1個を取り出し、別の鍵へ移します。まずextract.pyのphase_coefficientを実装し、phaseを提出してください。',
    description_en='Extract one encrypted value and move it to another key. First implement phase_coefficient in extract.py and submit phase.',
