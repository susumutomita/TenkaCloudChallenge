...
`review.py` against the player's own readings, in their own terminal; by the time a
        ...
        self._respond(
            200,
            {
                ...
                "message": (
                    "Flag accepted."
                    if correct
                    else "That is not the flag for this deployment. `review flag` prints it "
                    "once all five stages are cleared."
                ),
            },
        )
