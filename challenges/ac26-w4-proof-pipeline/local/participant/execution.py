...
class LearnerSession:
    ...
    def module(self):
        ...
        return SimpleNamespace(**{name: function(name) for name in ('artifact_graph', 'dangling_artifacts', 'check_inputs', 'check_constraints', 'check_commitment', 'check_transcript', 'check_openings', 'check_degree', 'assumption_matrix', 'unsupported_claims', 'layer_order', 'first_fault', 'repair')})
