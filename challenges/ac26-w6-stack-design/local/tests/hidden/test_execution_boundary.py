...
class ExecutionBoundaryTests(unittest.TestCase):
    ...
    def test_legal_alternative(self):
        source = REFERENCE + '\n_copied_repair = repair\n_copied_counterexample = counterexample\ndef repair(built):\n    fixed = dict(_copied_repair(built))\n    built.clear()\n    built.update(fixed)\n    return built\ndef counterexample(built, prop):\n    candidate = dict(_copied_counterexample(built, prop))\n    built.clear()\n    built.update(candidate)\n    return built\n'
