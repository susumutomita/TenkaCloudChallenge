...
def _check_total(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["total"], submission) and bool(SEED)


def _check_allocate(submission: object) -> bool:
    return _check_code(CODE_CHECKPOINT_PHASES["allocate"], submission) and bool(SEED)
