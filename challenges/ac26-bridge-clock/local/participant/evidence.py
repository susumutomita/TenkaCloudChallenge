...
public values only, this drill's `setting(seed)` returns the graded values' expected
...
tests/public/test_clock_drill.py — goes through `public_evidence` below, so there
