...
Issue 537/543 (option B2): this problem's `fixtures/generate.py` computes the fourteen
...
#: of the fourteen drill lines have an answer field (the platform's maximum per problem).
CHECKPOINTS = GRADED
...
def main() -> None:
    port = int(os.environ.get("VERIFY_PORT", "18164"))
