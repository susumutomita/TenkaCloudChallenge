# Accept three parcels — Lambda basics
...
Provided Lambda receiver → execution receipt → explain input validation.
...
Two 128 MB Lambda functions (student and checker), two one-day log groups, scoped roles and a capability-protected function URL.
...
The checker reads only the student log group and matches receipt, team and parcel count. Pasted text alone cannot pass.
