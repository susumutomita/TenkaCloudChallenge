...
_WORKBENCH = PortalEditorSupport(
    ...
    description='短くした式が元の式とつながっているかを調べる8問。5か7で割った余りから始め、最後は検査を通る偽物を2種類作り、6個の係数を提出します。',
    description_en='Eight checkpoints connect a folded expression to its original. Start with remainders by 5 or 7, then construct two alterations that pass inspection and submit six coefficients.',
    checkpoint_labels={'poly': '元の式を3か所で計算する', 'fold': '式を折って短くする', 'fold2': 'もう一度折って一つの数にする', 'query': '左右の2点を読む', 'recover': '和と差で偶数・奇数の成分を戻す', 'consistency': '折る前後を照合する', 'cheat-caught': '短い式のすり替えを見つける', 'miss-points': '検査を通る偽物を2種類作る'},
    checkpoint_labels_en={'poly': 'Evaluate the original at three positions', 'fold': 'Fold to a shorter expression', 'fold2': 'Fold again to one number', 'query': 'Read two opposite positions', 'recover': 'Recover the even and odd values', 'consistency': 'Check the first fold', 'cheat-caught': 'Detect an altered short expression', 'miss-points': 'Construct two alterations that pass inspection'},
