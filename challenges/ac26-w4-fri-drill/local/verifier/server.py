...
This problem's `verifier/expected.py` computes the eight expected values from
...
def public_payload(seed: str) -> dict[str, object]:
    ...
    the same numbers as a dict. Only the public values travel; expected values remain in the verifier.
    """
