...
_WORKBENCH = PortalEditorSupport(
    ...
    description='数の並びの掛け算で端の符号を直す教材です。lwe.pyのnormalizeから始め、秘密鍵との積を加えるLWEとRLWEの計算へ進みます。小さい数の模型であり実用の安全性はありません。',
    description_en='Repair the sign at the end of polynomial multiplication. Start with normalize in lwe.py, then implement LWE and RLWE calculations using a secret-key product. This small-number model does not provide practical security.',
