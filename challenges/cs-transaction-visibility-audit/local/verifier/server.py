...
def main() -> None:
    ...
    # Host loopback is enforced by compose.  Inside the container the published-port
    # forward reaches the bridge address, so the process must listen on all interfaces.
