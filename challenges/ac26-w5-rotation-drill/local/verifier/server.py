...
from fixtures.generate import GRADED, LINES, assignments, normalize_answer, setting, submission_binding, valid_window, valid_edge
...
def _check_line(line: str, submission: object) -> bool:
    ...
    if got is None:
        return False
    if line in ("window","edge"):
        return (valid_window if line=="window" else valid_edge)(setting(SEED)["public"], got)
