...
'boundary':('n',),'hazard':('n','lo'),'rotations':('p','n','noise_a','noise_b','encoding'),
'constants':('p','n','dmax','repair_noise','encoding'),'margin':('p','n','repair_noise','encoding')}
EXAMPLE={'p':16,'n':8,'noise_a':1,'noise_b':0,'dmax':1,'lo':2,'hi':9,'probes':[0,7,8,9,15,16],'repair_noise':2,'encoding':[-1,1]}
