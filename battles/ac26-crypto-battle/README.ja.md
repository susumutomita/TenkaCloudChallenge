...
ということです。現在は artifact が他 2 拠点の partial と 3 つの和を持ち、ledger の行に
`a + b + c = 合計` の形で並びます。足し算は参加者自身が確かめられます — それが学ぶべき
中身であって、結果だけを渡されることではありません。これらの公開は、partial 1 つの公開が
安全なのと同じ理屈で安全です。
