...
問題の目的と「ルール・暗号のしくみ・練習（無料）」を盤面の上に置きます。解説と練習は任意で開き、本番の進行を遮りません。練習は、余り・秘密分散・MPC・ZK・FHE・シーザー暗号を一桁の穴埋めで順に体験し、正答後にその計算の意味を説明します。数独 PROVE は表を選び、12 マスの見本を見ながら 4 マスだけを入力します。
