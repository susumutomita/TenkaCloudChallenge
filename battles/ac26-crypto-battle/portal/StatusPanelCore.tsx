...
import { ledgerKindLabel, ledgerPayload, orderDetail, orderLabel } from "./orderTask.ts";
...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    colShareIndex: "Index",
    colShareValue: "Value",
    rotateCooldownLabel: "Legacy API rotation cooldown",
    rotateReady: "ready now",
    huntedGenerationsLabel: "Generations successfully HUNTed against you",
    sudokuHuntedGenerationsLabel: "Generations whose sudoku solution was recovered from your reused relabelling",
    none: "none",
  ...
  ja: {
    ...
    colShareIndex: "Index",
    colShareValue: "値",
    rotateCooldownLabel: "旧APIの世代更新クールダウン",
    rotateReady: "今すぐ実行可",
    huntedGenerationsLabel: "自チームが HUNT された世代",
    sudokuHuntedGenerationsLabel: "付け替えの使い回しから数独の解を割り出された世代",
    none: "なし",
    ledgerTitle: "Public Ledger",
            ...
            {open.map((c) => {
              ...
              return (
                <tr key={c.id}>
                  ...
                  */}
                  <td style={tdStyle}>
                    {orderLabel(c, locale)} · {orderDetail(c, locale)}
                  </td>
