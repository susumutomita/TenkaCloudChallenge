...
type Locale = "ja" | "en";
export type Concept = "snark" | "ec" | "schnorr" | "remainder" | "sharing" | "mpc" | "zk" | "fhe" | "caesar" | "vigenere" | "rsa" | "rotor" | "commit";
...
export default function ConceptExplanation({ locale, topic, task, prime, embedded = false }: {
  ...
  const topics = topic ? [topic] : (["remainder", "sharing", "schnorr", "zk", "commit", "mpc", "fhe", "caesar", "vigenere", "rotor", "rsa", "ec", "snark"] as Concept[]);
