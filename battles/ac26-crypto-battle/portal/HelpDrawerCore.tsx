...
const COPY = {
  ja: {
    ...
    moves: [
      ...
      { name: "PROVE — ゼロ知識証明（Schnorr）", body: "公開値yに対応する数xを使って、Schnorrの検証式を手計算する模型です。候補が11通りなので、合格は秘密を知っていた保証にはなりません。シェアや数独の解は検査しません。a→e→zの順に会話し、検証者は2ᶻ ≡ a×yᵉ (mod23)を確認。秘密xは受け取りません。図と式の解説で、なぜ秘密を増やさないかを確かめられます。小さい数のHVZK教材で、旧試合の数独模型とは別方式です。" },
