...
export const PRACTICE_STEPS: readonly PracticeStep[] = [
  ...
  },
  {
    ...
    ja: {
      ...
      purpose: "Schnorr（シュノア）証明は、公開値 y に対応する秘密 x を知っていると示す手順です。ZK（ゼロ知識）は検証者にも秘密を教えない性質です。ここでは小さい数で、値を固定→質問→応答の順を練習します。候補が11通りなので、模型の合格は秘密を知っていた保証にはなりません。",
    ...
    en: {
      ...
      purpose: "A Schnorr proof demonstrates knowledge of secret x for public value y. Zero knowledge (ZK) means the verifier learns no secret. Practise the sequence: fix a value, receive a question, respond. With only 11 possible secrets, acceptance in this model does not certify prior knowledge.",
