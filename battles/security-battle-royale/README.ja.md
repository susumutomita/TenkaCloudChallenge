...
天下クラウド株式会社、 ある月曜の朝。 噂は聞くが顔は見たことのない前任の SRE が、 「Tenryu.Mart」 を残していった。 去年の買収案件。 mysql + Flask + nginx が EC2 1 台に同居。 監視ダッシュボードは緑、 ただしコードは誰も読んでいない。

> CTO 曰く: 「攻撃来てる。 他チームのも一緒に来てる。 落とすな、 全部直すな、 とにかく 200 を返し続けて。 トリアージ」
