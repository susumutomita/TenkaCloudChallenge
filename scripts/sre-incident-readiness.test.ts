...
const APP = join(dirname(fileURLToPath(import.meta.url)), "../battles/sre-incident-readiness/local/app");
const PROBLEM_DIR = join(dirname(fileURLToPath(import.meta.url)), "../battles/sre-incident-readiness");
