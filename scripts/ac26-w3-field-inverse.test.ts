...
describe("ac26-w3-field-inverse: metadata contracts", () => {
  ...
  // and assignment it sits beside rather than a placeholder. The pins moved once since
  // authoring: upstream added a lecture-slides link to week3/README.md (the exercise
  // README is unchanged), and the ref was re-pinned after reading that diff, per
  // SYNC.md §3/§5. The exact sources are pinned here so a ref bumped without a review
  // shows up as a diff.
