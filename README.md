...
For a beginner social event, try [Office Link](challenges/office-link-gameday/README.md): complete Preparation as a team of four, unlock GameDay through the existing Gate, and tackle one task at a time. Repairs and explanations score separately. It includes a 60-minute host script, AWS event hosting and an unscored local preview.
